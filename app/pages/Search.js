...
export default class Search extends React.Component {
    ...
    render() {
        ...
        if (Search && Search.history && Search.history.length) {
        ...
        if (Search && Search.keywordsList && Search.keywordsList.length) {
        ...
        if (Search && Search.history && Search.history.length) {
            ...
            sourceData = {'keywordsList': [Search && Search.keywordsList]};
        }
        return (
